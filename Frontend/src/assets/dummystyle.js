export const landingPageStyles = {
  ...
  // Adjusted description to be responsive
  ...
  ctaButtons: 'flex flex-col sm:flex-row gap-2 mt-3', // Added margin-top for spacing
    
    // Add these new styles for the stats section
      
    statsGrid: "grid grid-cols-2 sm:grid-cols-3 gap-6 mt-10",
    statItem: "flex flex-col items-center text-center",
    
    // Updated statValue to include the text-transparent and bg-clip-text classes
    statValue: "text-2xl sm:text-3xl lg:text-4xl font-black bg-clip-text text-transparent",
    
    statLabel: "mt-1 text-sm sm:text-base text-gray-500 font-medium",
  // Hero illustration
...
export const dashboardStyles = {
  ...
  // Create Button
createButton: "group relative px-8 py-4 bg-gradient-to-r from-violet-700 to-fuchsia-700 text-white font-bold rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-lg border-2 border-violet-500/20",
createButtonOverlay: "absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300",
createButtonContent: "relative flex items-center justify-center gap-2 text-lg font-semibold z-10 drop-shadow-md",
  // Loading
...
// This is a dummy style file for demonstration. In a real project,
// you'd use a CSS-in-JS library, Tailwind CSS, or a separate CSS file.

export const authStyles = {
      loginContainer: 'flex flex-col items-center justify-center p-6 bg-white rounded-lg shadow-xl w-full max-w-sm mx-auto',
    headerWrapper: 'text-center mb-6', // Increased margin-bottom
    loginTitle: 'text-3xl font-bold text-gray-900 mb-2', // Slightly larger title
    loginSubtitle: 'text-md text-gray-600', // Adjusted font size
    form: 'w-full space-y-5', // Increased space between form elements
    errorMessage: 'text-red-500 text-sm text-center mt-3',
    loginSubmit: 'w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-purple-700 hover:to-indigo-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50 mt-6', // Added margin-top

    // For the switch text at the bottom
    switchText: 'text-sm text-gray-600 text-center mt-6', // Increased margin-top
    switchButton: 'text-purple-600 font-semibold hover:underline ml-1',

    // SignUp specific styles (similar adjustments)
    signupContainer: 'flex flex-col items-center justify-center p-6 bg-white rounded-lg shadow-xl w-full max-w-sm mx-auto',
    signupTitle: 'text-3xl font-bold text-gray-900 mb-2',
    signupSubtitle: 'text-md text-gray-600',
    signupForm: 'w-full space-y-5',
    signupSubmit: 'w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-purple-700 hover:to-indigo-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50 mt-6',
    switcchText: 'text-sm text-gray-600 text-center mt-6', // Corrected typo here if 'switcchText' was intentional
    signupSwitchButton: 'text-purple-600 font-semibold hover:underline ml-1',
};
...
export const modalStyles = {
    overlay: "fixed inset-0 z-[100] bg-black bg-opacity-50 flex items-center justify-center",
    container: "relative w-full max-w-sm mx-auto p-6 bg-white rounded-lg shadow-lg",
    header: "flex justify-between items-center mb-4 pb-2 border-b",
    title: "text-2xl font-bold text-gray-800",
    
    // Position the close button absolutely
    closeButton: "absolute top-2 right-2 p-2 rounded-full text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors duration-200",
