...
import Modal from '../components/Modal'; // ADDED: Import the Modal component
...
              </div>
              {/* STATS GRID */}
              <div className={landingPageStyles.statsGrid}>
                {[
...
                    <div className={`${landingPageStyles.statLabel} ${stat.gradient}`}>
                      {stat.value}
                    </div>
...
                  <div className={landingPageStyles.featuresCardHover}></div>
...
            <a href="https://github.com/Sourish73" target="blank" className={landingPageStyles.footerLink}>
              SOURISH SINHA
            </a>
          </p>
        </div>
...
          {currentPage === "signup" && <SignUp setCurrentPage={setCurrentPage} />} {/* CORRECTED: Self-closing tag */}
        </div>
      </Modal>
    </div>
  );
